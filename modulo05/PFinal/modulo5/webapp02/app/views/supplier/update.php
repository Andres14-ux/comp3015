...
<div class="border border-secondary-300 p-4">
    ...
    <form action="index.php?url=supplier/save/<?php echo $supplier['id']; ?>" method="post" class='form'>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="suplidor" class='form-control' value="<?php echo $supplier['suplidor']; ?>" required>
        </div>
        <div class="form-group mb-3">
            <label>Cantidad</label>
            <input type="number" name="cantidad" class='form-control' placeholder="Cantidad" value="<?php echo $supplier['cantidad']; ?>" required>
        </div>
        <div class="form-group mb-3">
            <label>Precio</label>
            <input type="number" name="precio" class='form-control' placeholder="Precio" value="<?php echo $supplier['precio']; ?>" required>
        </div>
