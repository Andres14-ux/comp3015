<div class="border border-secondary-300 p-4">
    ...
    <form action="index.php?url=product/save/0" method="post" class='form'>
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" name="cantidad" class='form-control' placeholder="Nueva Contraseña" value="" required>
        </div>
        <div class="form-group mb-3">
            <label>Precio</label>
            <input type="number" name="precio" class='form-control' placeholder="Nueva Contraseña" value="" required>
        </div>
